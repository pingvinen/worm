...
{
	public class PostgresWormDbConnection : IWormDbConnection
	{
		protected string connectionString;
		protected NpgsqlConnection connection;

		public PostgresWormDbConnection(string connectionString)
		{
		...
		protected virtual void Dispose(bool disposing)
		{
			...
			if (!this.disposed)
			{
				...
				if (disposing)
				{
					...
					if (this.connection != default(NpgsqlConnection))
					{
